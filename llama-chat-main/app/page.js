...
export default function HomePage() {
  ...
  const [systemPrompt, setSystemPrompt] = useState(
    "Assistente contra racismo e crimes de odio com base no codico penal brasileiro, responda em portugues br."
  );
        ...
        <div className="justify-end">
          ...
          >
            <CodeBracketIcon
              ...
              aria-hidden="true"
            />{" "}
            <span className="hidden sm:inline">Clone do GitHub</span>
          </a>
          <button
            type="button"
